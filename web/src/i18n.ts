...
type TranslationKey =
  ...
  | 'settings.skin'
  | 'settings.skinMatrix'
  | 'settings.skinOfficial'
  | 'settings.skinHint'
  | 'settings.fxScan'
  | 'settings.fxScanDesc'
  | 'settings.fxDecode'
  | 'settings.fxDecodeDesc'
  | 'settings.fxRain'
  | 'settings.fxRainDesc'
  | 'settings.fxRainOff'
  | 'settings.fxRainLow'
  ...
  | 'detail.micLabel'
  | 'detail.micListening'
  | 'detail.micUnsupported'
  | 'detail.modeToggleLabel'
  | 'detail.modeChat'
  | 'detail.modeTerminal'
  | 'detail.terminalTitle'
  | 'detail.terminalHint'
  | 'detail.terminalPlaceholder'
  | 'detail.terminalRunning'
  | 'detail.terminalPrompt'
  | 'sidebar.collapse'
  | 'inspector.todo'
  | 'inspector.diag'
  | 'inspector.files'
...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  en: {
    ...
    'settings.skin': 'Appearance style',
    'settings.skinMatrix': 'Matrix',
    'settings.skinOfficial': 'OpenCode',
    'settings.skinHint': 'Matrix = phosphor FX. OpenCode = clean warm-neutral.',
    'settings.fxScan': 'Scanlines + CRT glow',
    'settings.fxScanDesc': 'Scanline overlay + phosphor glow',
    'settings.fxDecode': 'Decode (live)',
    'settings.fxDecodeDesc': 'Live message decodes from katakana',
    'settings.fxRain': 'Background rain',
    'settings.fxRainDesc': 'Falling katakana in the background',
    'settings.fxRainOff': 'Off',
    'settings.fxRainLow': 'Subtle',
    'settings.fxRainMed': 'Medium',
    'settings.fxRainHigh': 'Intense',
    'settings.pushSection': 'Push notifications',
    'settings.pushRelayUrl': 'Push relay URL',
    'settings.pushRelayApiKey': 'Push relay API key',
    'settings.pushHint': 'Register this device with your relay so OpenCodeBar can push you when a session finishes.',
    ...
    'detail.send': 'Send',
    'detail.micLabel': 'Voice input',
    'detail.micListening': 'Listening...',
    'detail.micUnsupported': 'Voice input unavailable on this device',
    'detail.modeToggleLabel': 'View mode',
    'detail.modeChat': 'Chat',
    'detail.modeTerminal': 'Shell',
    'detail.terminalTitle': 'Shell — one-shot commands',
    'detail.terminalHint': 'runs in the session directory',
    'detail.terminalPlaceholder': 'run a command… (e.g. git status)',
    'detail.terminalRunning': 'running',
    'detail.terminalPrompt': '$',
    'sidebar.collapse': 'Collapse sidebar',
    'inspector.todo': 'Todo',
    'inspector.diag': 'Diagnostics',
    'inspector.files': 'Files',
    'inspector.emptyTodo': 'No todos yet',
    'palette.placeholder': 'Search commands, sessions, actions…',
    'palette.groupNav': 'Navigate',
    'palette.groupActions': 'Session actions',
    'palette.groupSessions': 'Sessions',
    'palette.groupSlash': 'Slash commands',
    'palette.toggleFx': 'Toggle Matrix FX',
    'palette.abort': 'Abort session',
    'fx.autoDegraded': 'Reduced Matrix FX for performance — adjust in Settings',
    'question.title': 'The assistant is asking',
    'question.back': 'Back',
    'question.next': 'Next',
  ...
  it: {
    ...
    'settings.skin': 'Stile aspetto',
    'settings.skinMatrix': 'Matrix',
    'settings.skinOfficial': 'OpenCode',
    'settings.skinHint': 'Matrix = effetti fosforo. OpenCode = neutro caldo pulito.',
    'settings.fxScan': 'Scanlines + glow CRT',
    'settings.fxScanDesc': 'Sovrapposizione scanline + glow fosforo',
    'settings.fxDecode': 'Decode (live)',
    'settings.fxDecodeDesc': 'Il messaggio live si decodifica da katakana',
    'settings.fxRain': 'Pioggia di sfondo',
    'settings.fxRainDesc': 'Katakana cadenti sullo sfondo',
    'settings.fxRainOff': 'Off',
    'settings.fxRainLow': 'Sottile',
    'settings.fxRainMed': 'Medio',
    'settings.fxRainHigh': 'Intenso',
    'settings.pushSection': 'Notifiche push',
    'settings.pushRelayUrl': 'URL del relay push',
    'settings.pushRelayApiKey': 'Chiave API del relay push',
    'settings.pushHint': 'Registra questo dispositivo presso il tuo relay così OpenCodeBar può avvisarti quando una sessione termina.',
    ...
    'detail.send': 'Invia',
    'detail.micLabel': 'Input vocale',
    'detail.micListening': 'In ascolto...',
    'detail.micUnsupported': 'Input vocale non disponibile su questo dispositivo',
    'detail.modeToggleLabel': 'Modalità visuale',
    'detail.modeChat': 'Chat',
    'detail.modeTerminal': 'Shell',
    'detail.terminalTitle': 'Shell — comandi monouso',
    'detail.terminalHint': 'esegue nella directory della sessione',
    'detail.terminalPlaceholder': 'esegui un comando… (es. git status)',
    'detail.terminalRunning': 'in esecuzione',
    'detail.terminalPrompt': '$',
    'sidebar.collapse': 'Comprimi barra laterale',
    'inspector.todo': 'Da fare',
    'inspector.diag': 'Diagnostica',
    'inspector.files': 'File',
    'inspector.emptyTodo': 'Nessun elemento',
    'palette.placeholder': 'Cerca comandi, sessioni, azioni…',
    'palette.groupNav': 'Naviga',
    'palette.groupActions': 'Azioni sessione',
    'palette.groupSessions': 'Sessioni',
    'palette.groupSlash': 'Comandi slash',
    'palette.toggleFx': 'Attiva/disattiva FX Matrix',
    'palette.abort': 'Interrompi sessione',
    'fx.autoDegraded': 'Effetti Matrix ridotti per le prestazioni — regola in Impostazioni',
    'question.title': 'L\'assistente sta chiedendo',
    'question.back': 'Indietro',
    'question.next': 'Avanti',
    'question.submit': 'Invia',
    'question.skip': 'Ignora',
    'question.other': 'Altro…',
    'question.otherPlaceholder': 'Scrivi la tua risposta…',
    'question.answered': 'Risposta inviata',
    'question.skipped': 'Domanda ignorata',
  ...
  'zh-TW': {
    ...
    'settings.skinMatrix': 'Matrix',
    'settings.skinOfficial': 'OpenCode',
    'settings.skinHint': 'Matrix＝磷光特效。OpenCode＝乾淨暖中性。',
    'settings.fxScan': '掃描線 + CRT 光暈',
    'settings.fxScanDesc': '掃描線覆蓋 + 磷光',
    'settings.fxDecode': '解碼（即時）',
    'settings.fxDecodeDesc': '即時訊息從假名解碼',
    'settings.fxRain': '背景字雨',
    'settings.fxRainDesc': '背景墜落的假名',
    'settings.fxRainOff': '關閉',
    'settings.fxRainLow': '微弱',
    'settings.fxRainMed': '中等',
    'settings.fxRainHigh': '強烈',
    'settings.pushSection': '推播通知',
    'settings.pushRelayUrl': '推播中繼 URL',
    'settings.pushRelayApiKey': '推播中繼 API 金鑰',
    'settings.pushHint': '向你的中繼註冊此裝置，讓 OpenCodeBar 能在工作階段結束時推播通知給你。',
    'sessions.title': '工作階段',
    ...
    'detail.waiting': '等待中...',
    'detail.send': '傳送',
    'detail.micLabel': '語音輸入',
    'detail.micListening': '聆聽中…',
    'detail.micUnsupported': '此裝置不支援語音輸入',
    'detail.modeToggleLabel': '顯示模式',
    'detail.modeChat': '聊天',
    'detail.modeTerminal': 'Shell',
    'detail.terminalTitle': 'Shell — 單次指令',
    'detail.terminalHint': '於工作階段目錄執行',
    'detail.terminalPlaceholder': '執行指令…（例如 git status）',
    'detail.terminalRunning': '執行中',
    'detail.terminalPrompt': '$',
    'sidebar.collapse': '收合側邊欄',
    'inspector.todo': '待辦',
    'inspector.diag': '診斷',
    'inspector.files': '檔案',
    'inspector.emptyTodo': '尚無待辦事項',
    'palette.placeholder': '搜尋指令、工作階段、操作…',
    'palette.groupNav': '導覽',
    'palette.groupActions': '工作階段操作',
    'palette.groupSessions': '工作階段',
    'palette.groupSlash': '斜線指令',
    'palette.toggleFx': '切換 Matrix 特效',
    'palette.abort': '中止工作階段',
    'fx.autoDegraded': '已為效能降低 Matrix 特效 — 可在設定中調整',
    'question.title': '助理正在詢問',
    'question.back': '返回',
    'question.next': '下一步',
    'question.submit': '送出',
    'question.skip': '略過',
    ...
    'question.answered': '已送出回答',
    'question.skipped': '已略過問題',
